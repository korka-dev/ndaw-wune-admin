...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/evaluation-docs",        label: "Dossiers d'évaluation", icon: "doc",       adminOnly: true },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/identifiants", label: "Identifiants tuteurs/superviseurs", icon: "key", adminOnly: true },
...
type IconName = "calendar"|"home"|"school"|"users"|"users-sm"|"activity"|"clock"|"book"|"check"|"check-sq"|"shield"|"doc"|"lock"|"key"|"supervisor"|"eye"|"file-text"|"import";
...
function NavIcon({ name }: { name: IconName }) {
  ...
  switch (name) {
    ...
    case "key":        return <svg {...p}><circle cx="7.5" cy="15.5" r="5.5"/><path d="M21 2l-9.6 9.6"/><path d="M15.5 7.5L19 11l3-3"/></svg>;
